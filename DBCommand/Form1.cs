...
namespace DBCommand
{
    public partial class Form1 : Form
    {
        ...
        private void CallProcButton_Click(object sender, EventArgs e)
        {
            StringBuilder results = new StringBuilder(); 
            using (sqlConnection1)
            {
        ...
        private void QueryWithParamButton_Click(object sender, EventArgs e)
        {
        ...
        private void ProcedureWithParButton_Click(object sender, EventArgs e)
        {
            StringBuilder results = new StringBuilder(); try
            {
