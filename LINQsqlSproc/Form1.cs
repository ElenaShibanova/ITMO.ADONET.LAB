...
namespace LINQsqlSproc
{
    public partial class Form1 : Form
    {
        ...
        Northwnd db = 
            new Northwnd(@"Data Source=(LocalDB)\MSSQLLocalDB;Initial Catalog=Northwind;Integrated Security=True");


        private void DetailsOrderButton_Click(object sender, EventArgs e)
        {
        ...
        private void OrderStoryButton_Click(object sender, EventArgs e)
        {
