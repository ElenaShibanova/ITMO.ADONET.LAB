...
{
    public partial class DataAdapterWizardForm : Form
    {
        public DataAdapterWizardForm()
        {
            InitializeComponent();
        }

        private void DataAdapterWizardForm_Load(object sender, EventArgs e)
        {
        ...
        private void sqlDataAdapter1_RowUpdating(object sender, System.Data.SqlClient.SqlRowUpdatingEventArgs e)
        {
            ...
            MessageBox.Show("Continue updating " + CustRow.CustomerID.ToString() + "?", "Continue Update?", MessageBoxButtons.YesNo);
